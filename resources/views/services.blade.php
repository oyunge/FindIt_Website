                          ...
                          <div class="single-footer-caption mb-30">
                              ...
                              <div class="footer-tittle">
                                  <div class="footer-pera">
                                      <p class="info1">FindIt system intelligently finds and locates items lost or found and who potentially has.</p>
                                 </div>
                              </div>
                          </div>
                     </div>
                     ...
                     <div class="col-lg-3 col-md-6 col-sm-8">
                         <div class="single-footer-caption mb-50">
                             <div class="footer-tittle">
                                 ...
                                 <p>Subscribe to our App to get the latest update of the new features in our App </p>
                              </div>
                              <!-- Form -->
                     ...
                     <div class="col-xl-12 ">
                         <div class="footer-copy-right">
                             <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved |</i> FindSystems</a>
